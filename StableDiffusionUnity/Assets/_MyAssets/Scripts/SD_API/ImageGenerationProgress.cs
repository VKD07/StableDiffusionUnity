...
public class ImageGenerationProgress : MonoBehaviour
{
    ...
    private void Start()
    {
        UIManager.instance.SetActiveSliderProgressUI(false);
    }
    ...
    public IEnumerator RequestImageGenerationProgress()
    {
        while (getProgressValue)
        {
            ...
            UIManager.instance.SetActiveSliderProgressUI(true);
            yield return RequestGenerationProgressFromWeb();
            UIManager.instance.SetProgressSliderValue(progressValue);
        }
    }
